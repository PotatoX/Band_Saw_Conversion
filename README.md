...
<img src="https://github.com/PotatoX/Band_Saw_Conversion/tree/master/Software/Arduino/Tachometer_Rev_A/Tachometer.jpg" width="20%" height="20%">
...
3. Measure the diameter of one of your blade drive wheels. <img src="https://github.com/PotatoX/Band_Saw_Conversion/tree/master/Software/Arduino/Tachometer_Rev_A/Method1.jpg" width="20%" height="20%">
...
7. Using a [spread sheet](https://github.com/PotatoX/Band_Saw_Conversion/tree/master/Software/Arduino/Tachometer_Rev_A/BandSaw Slope Calculations.ods) convert the tachometer readings to SFM
8. Using a [spread sheet](https://github.com/PotatoX/Band_Saw_Conversion/tree/master/Software/Arduino/Tachometer_Rev_A/BandSaw Slope Calculations.ods) plot the controller readings vs the SFM(tachometer readings).
...
1. Measure the diameter of one of your blade drive wheels. <img src="https://github.com/PotatoX/Band_Saw_Conversion/tree/master/Software/Arduino/Tachometer_Rev_A/Method2.jpg" width="20%" height="20%">
2. Count the teeth of the motor pully and the blade wheel pully.
3. Enter the all values in the [spread sheet](https://github.com/PotatoX/Band_Saw_Conversion/tree/master/Software/Arduino/Tachometer_Rev_A/BandSaw Slope Calculations.ods).
